...
date.date = function (mS, dividerType) {
  ...
  // return this.formatTimeNumber(month) + divider + this.formatTimeNumber(monthDate)
};
...
date.time = function (mS, dividerType) {
  ...
  return this.formatTimeNumber(hour) + divider + this.formatTimeNumber(minute);
};
